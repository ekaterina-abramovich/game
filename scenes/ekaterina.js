...
class ekaterina extends Scene {
    ...
    draw() {
        ...
        if (this.characterLion.y > 500) {

        isJumpingLion = false;
        this.characterLion.y = 500;
        this.characterLion.y_velocity = 0;
        }
        ...
        //lion animations
        if (isJumpingLion && isWalkingRightLion == false && isWalkingLeftLion == false) {
            this.characterLion.changeAnimation('lionjumpsup');
        } 
        
        else if (isWalkingRightLion && 500 == this.characterLion.y) {
            this.characterLion.changeAnimation('lionmovesright');
            
        } else if (isWalkingLeftLion && 500 == this.characterLion.y) {
        ...
        } else if (500 == this.characterLion.y) {
